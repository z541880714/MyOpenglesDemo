...
import com.example.glesjavademo.R;
import com.example.glesjavademo.util.AssetsUtil;
import com.example.glesjavademo.util.GLUtil;
import com.example.glesjavademo.util.ResReadUtils;
import com.example.glesjavademo.util.ShaderUtils;
...
public class VertexPointerRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //编译
        String vert = AssetsUtil.readAssetsFile(AppContext.getAppContext().getAssets(), "shader/vertex_pointer_shader.vert");
        String frag = AssetsUtil.readAssetsFile(AppContext.getAppContext().getAssets(), "shader/fragment_pointer_shader.frag");

        mProgram = GLUtil.glCreateProgramId(vert, frag);
        //使用程序片段
